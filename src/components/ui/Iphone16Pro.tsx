/*
 * Iphone16Pro — mockup SVG de iPhone que exibe uma imagem na tela.
 * (Adaptado para TypeScript.)
 */
import type { SVGProps } from 'react'

interface Iphone16ProProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  width?: number
  height?: number
  /** URL da imagem exibida na tela do celular. */
  src?: string
}
    ...
    >
      ...
      {src && (
        <image
          ...
          clipPath="url(#iphone16-screen-clip)"
        />
      )}
      ...
      <defs>
        <clipPath id="iphone16-screen-clip">
